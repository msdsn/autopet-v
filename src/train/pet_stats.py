...
STORE = "/content/nnUNet/prep_local/Dataset998_AutoPETV/nnUNetPlans_3d_fullres"


def main(store: str = STORE) -> None:
    """Print the per-tracer medians of the store's PET z-score constants."""
    files = sorted(glob.glob(os.path.join(store, "*.pkl")))
